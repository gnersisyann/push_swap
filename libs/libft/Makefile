...
SRC     = ft_atoi.c ft_bzero.c ft_calloc.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c ft_isprint.c \
			...
			ft_strtrim.c ft_strjoin.c ft_strmapi.c ft_strnstr.c ft_striteri.c
